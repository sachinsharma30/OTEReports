...
# Headers for CSV (added "Season" column)
csv_headers = [
...
for player_id in player_ids:
    ...
    for season_name, season_id in seasons.items():
        ...
        if not season_stats or not season_stats.get("games"):
            # Skip player-season if no data or GP = 0
            continue
        ...
        row_data = [
            ...
            format_number(season_stats.get("minutes", 0)),
            format_number(season_stats.get("points", 0)),
            format_number(season_stats.get("rebounds_offensive", 0)),
            format_number(season_stats.get("rebounds_defensive", 0)),
            format_number(season_stats.get("rebounds_total", 0)),
            format_number(season_stats.get("assists", 0)),
            format_number(season_stats.get("turnovers", 0)),
            format_number(season_stats.get("steals", 0)),
            format_number(season_stats.get("blocks", 0)),
            format_number(season_stats.get("fouls_personal", 0)),
            format_number(season_stats.get("fouls_drawn", 0)),
            format_number(season_stats.get("points_two_made", 0)),
            format_number(season_stats.get("points_two_attempted", 0)),
            format_number(season_stats.get("points_two_percentage", 0.0), is_percent=True),
            format_number(season_stats.get("points_three_made", 0)),
            format_number(season_stats.get("points_three_attempted", 0)),
            format_number(season_stats.get("points_three_percentage", 0.0), is_percent=True),
            format_number(season_stats.get("field_goals_made", 0)),
            format_number(season_stats.get("field_goals_attempted", 0)),
            format_number(season_stats.get("field_goals_percentage", 0.0), is_percent=True),
            format_number(season_stats.get("free_throws_made", 0)),
            format_number(season_stats.get("free_throws_attempted", 0)),
            format_number(season_stats.get("free_throws_percentage", 0.0), is_percent=True),
            format_number(season_stats.get("plus_minus", 0)),
        ]
...
print(f"✅ Clean player totals saved to `{csv_filename}` successfully!")
